...
VistaUsuario.prototype = {
  ...
  reconstruirLista: function() {
    ...
    preguntas.forEach(function(clave){
      ...
      //Se agrega a listaPreguntas un elemento div con valor "clave.textoPregunta", texto "clave.textoPregunta", id "clave.id"
  ...
  agregarVotos: function(){
    ...
    $('#preguntas').find('div').each(function(){
        ...
        console.log("       Preg:   " + nombrePregunta + "       Resp " + respuestaSeleccionada + "     id  " + id);
